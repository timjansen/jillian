...
describe('jelTokenizer', function() {
  describe('tokenize()', function() {
     ...
     it('should parse operators', function() {
      assert.deepEqual(Tokenizer.tokenize('<=+?').tokens, [new Token(1, 1, TokenType.Operator, '<='), new Token(1, 3, TokenType.Operator, '+'), new Token(1, 4, TokenType.Operator, '?')]);
      ...
      assert.deepEqual(Tokenizer.tokenize('${}} {}').tokens, [new Token(1, 1, TokenType.Operator, '${'), new Token(1, 3, TokenType.Operator, '}'), new Token(1, 4, TokenType.Operator, '}'), new Token(1, 6, TokenType.Operator, '{}')]);
    });
