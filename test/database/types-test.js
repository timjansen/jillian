...
describe('Types', function() {
  ...
  it('checks functions', function() {
    ...
    jelAssert.fuzzy('function((c,v,x)=>1, true).checkType((c,v)=>55)', 1);
    jelAssert.fuzzy('function((c,v)=>1).checkType((c,x)=>1)', 1);
    jelAssert.fuzzy('function((c,v)=>1, true).checkType((c,x)=>1)', 1);
    jelAssert.fuzzy('function((c,o): int=>1).checkType((c,o)=>55)', 0);
    ...
    jelAssert.fuzzy('function((c:int,o:int)=>1, true).checkType(c=>55)', 1);
    ...
    jelAssert.fuzzy('function((c:int,v:int): int=>1, true).checkType((c,o)=>55)', 1);
    jelAssert.fuzzy('function((c:int,v:int): int=>1, false).checkType((c,o)=>55)', 0);
    jelAssert.fuzzy('function(()=>1).checkType((c)=>1)', 0);
    jelAssert.fuzzy('function(()=>1, true).checkType((c)=>1)', 0);
    jelAssert.fuzzy('function((c)=>1).checkType(()=>1)', 1);
    jelAssert.fuzzy('function((c)=>1, true).checkType(()=>1)', 1);
