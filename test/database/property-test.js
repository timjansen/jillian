...
const SimplePropertyType = require('../../build/database/dbProperties/SimplePropertyType.js').default;
const CategoryPropertyType = require('../../build/database/dbProperties/CategoryPropertyType.js').default;
const ComplexPropertyType = require('../../build/database/dbProperties/ComplexPropertyType.js').default;
const DictionaryPropertyType = require('../../build/database/dbProperties/DictionaryPropertyType.js').default;
const FunctionPropertyType = require('../../build/database/dbProperties/FunctionPropertyType.js').default;
const ListPropertyType = require('../../build/database/dbProperties/ListPropertyType.js').default;
const OptionPropertyType = require('../../build/database/dbProperties/OptionPropertyType.js').default;
